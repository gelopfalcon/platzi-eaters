...
export default function AddDish() {
    ...
    <div className="flex justify-center">
        ...
        <input
          ...
          className="mt-2 border rounded p-4"
          onChange={e => updateFormInput({ ...formInput, originCountry: e.target.value })}
        />
        <button onClick={addDish} className="font-bold mt-4 bg-blue-500 text-white rounded p-4 shadow-lg">
          Add food
        </button>
      </div>
